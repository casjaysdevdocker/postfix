...
ARG IMAGE_REPO="casjaysdevdocker/postfix"
...
ARG PACK_LIST="bash-completion git curl wget sudo unzip iproute2 openssl jq tzdata mailcap ncurses util-linux pciutils usbutils coreutils binutils findutils grep rsync zip tini py3-pip procps net-tools coreutils sed gawk grep attr findutils readline lsof less curl shadow certbot ca-certificates postfix supervisor rsyslog "
...
ENV HOSTNAME="casjaysdevdocker-postfix"
...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/postfix"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/postfix"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.revision="${GIT_COMMIT}"
LABEL org.opencontainers.image.source="https://github.com/casjaysdevdocker/postfix"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/postfix"
