...
DATA_DIR="/data/postfix"   # set data directory
CONF_DIR="/config/postfix" # set config directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
VAR_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/postfix"       # set the temp dir
RUN_DIR="/run/postfix"       # set scripts pid dir
LOG_DIR="/data/logs/postfix" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#SERVICE_USER="postfix"  # execute command as another user
#SERVICE_GROUP="postfix" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set password length
RANDOM_PASS_USER=""
RANDOM_PASS_ROOT=""
...
root_user_name="${POSTFIX_ROOT_USER_NAME:-}" # root user name
root_user_pass="${POSTFIX_ROOT_PASS_WORD:-}" # root user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
user_name="${POSTFIX_USER_NAME:-}"      # normal user name
user_pass="${POSTFIX_USER_PASS_WORD:-}" # normal user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
[ -f "/config/env/postfix.script.sh" ] && . "/config/env/postfix.script.sh" # Generated by my dockermgr script
[ -f "/config/env/postfix.sh" ] && . "/config/env/postfix.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$POSTFIX_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$POSTFIX_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$POSTFIX_USER_PASS_WORD}"             #
