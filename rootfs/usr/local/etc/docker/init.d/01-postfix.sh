...
# root user name
root_user_name="${POSTFIX_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${POSTFIX_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${POSTFIX_USER_NAME:-}"
# normal user password
user_pass="${POSTFIX_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
# Generated by my dockermgr script
[ -f "/config/env/postfix.script.sh" ] && . "/config/env/postfix.script.sh"
# Overwrite the variabes
[ -f "/config/env/postfix.sh" ] && . "/config/env/postfix.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
