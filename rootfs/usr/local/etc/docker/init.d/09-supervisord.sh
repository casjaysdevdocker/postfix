...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410220932-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  09-supervisord.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Oct 22, 2024 09:32 EDT
# @@File             :  09-supervisord.sh
# @@Description      :
...
DATA_DIR="/data/supervisord"   # set data directory
CONF_DIR="/config/supervisord" # set config directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the containers etc directory
ETC_DIR="/etc/supervisord"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the var dir
VAR_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/supervisord"       # set the temp dir
RUN_DIR="/run/supervisord"       # set scripts pid dir
LOG_DIR="/data/logs/supervisord" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#SERVICE_USER="supervisord"  # execute command as another user
#SERVICE_GROUP="supervisord" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set password length
RANDOM_PASS_USER=""
RANDOM_PASS_ROOT=""
...
EXEC_CMD_BIN='supervisord'               # command to execute
EXEC_CMD_ARGS='-c /etc/supervisord.conf' # command arguments
...
root_user_name="${SUPERVISORD_ROOT_USER_NAME:-}" # root user name
root_user_pass="${SUPERVISORD_ROOT_PASS_WORD:-}" # root user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
user_name="${SUPERVISORD_USER_NAME:-}"      # normal user name
user_pass="${SUPERVISORD_USER_PASS_WORD:-}" # normal user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
[ -f "/config/env/supervisord.script.sh" ] && . "/config/env/supervisord.script.sh" # Generated by my dockermgr script
[ -f "/config/env/supervisord.sh" ] && . "/config/env/supervisord.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$SUPERVISORD_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$SUPERVISORD_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$SUPERVISORD_USER_PASS_WORD}"             #
