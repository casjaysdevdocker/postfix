...
# set data directory
DATA_DIR="/data/supervisord"
# set config directory
CONF_DIR="/config/supervisord"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the temp dir
TMP_DIR="/tmp/supervisord"
# set scripts pid dir
RUN_DIR="/run/supervisord"
# set log directory
LOG_DIR="/data/logs/supervisord"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# command to execute
EXEC_CMD_BIN='supervisord'
# command arguments
EXEC_CMD_ARGS='-c /etc/supervisord.conf'
...
# root user name
root_user_name="${SUPERVISORD_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${SUPERVISORD_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${SUPERVISORD_USER_NAME:-}"
# normal user password
user_pass="${SUPERVISORD_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
# Generated by my dockermgr script
[ -f "/config/env/supervisord.script.sh" ] && . "/config/env/supervisord.script.sh"
# Overwrite the variabes
[ -f "/config/env/supervisord.sh" ] && . "/config/env/supervisord.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
